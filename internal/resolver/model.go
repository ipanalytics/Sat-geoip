...
const (
	...
	OperatorInmarsat         Operator = "inmarsat"
	OperatorThuraya          Operator = "thuraya"
	...
	OperatorIridium          Operator = "iridium"
	OperatorTelesat          Operator = "telesat"
	OperatorYahsat           Operator = "yahsat"
	OperatorHispasat         Operator = "hispasat"
	OperatorKacific          Operator = "kacific"
	OperatorKVH              Operator = "kvh"
	OperatorAnuvu            Operator = "anuvu"
	OperatorPanasonic        Operator = "panasonic_avionics"
	OperatorSatcomDirect     Operator = "satcom_direct"
	OperatorGogo             Operator = "gogo_business_aviation"
	OperatorRigNet           Operator = "rignet"
	OperatorNSSLGlobal       Operator = "nsslglobal"
	OperatorSkyPerfectJSAT   Operator = "sky_perfect_jsat"
	OperatorTelespazio       Operator = "telespazio"
	OperatorThaicom          Operator = "thaicom"
	OperatorRSCC             Operator = "rscc"
	OperatorGazpromSpace     Operator = "gazprom_space_systems"
	OperatorNBNSkyMuster     Operator = "nbn_sky_muster"
	OperatorTurksat          Operator = "turksat"
	OperatorOmniAccess       Operator = "omniaccess"
	OperatorCastorMarine     Operator = "castor_marine"
	OperatorNavarino         Operator = "navarino"
	OperatorTampnet          Operator = "tampnet"
	OperatorGilatTelecom     Operator = "gilat_telecom"
	OperatorSwarm            Operator = "swarm"
	OperatorSpaceXInfra      Operator = "spacex_infrastructure"
	OperatorCarnival         Operator = "carnival"
	OperatorRoyalCaribbean   Operator = "royal_caribbean"
	OperatorUSAP             Operator = "usap"
	OperatorKSAT             Operator = "ksat"
	OperatorThalesAvionics   Operator = "thales_avionics"
	OperatorLufthansaSystems Operator = "lufthansa_systems"
	OperatorCapRock          Operator = "caprock"
	OperatorBentleyWalker    Operator = "bentley_walker"
	OperatorITCGlobal        Operator = "itc_global"
	OperatorChinaSatcom      Operator = "china_satcom"
	OperatorAPSTAR           Operator = "apstar"
	OperatorMorsviazsputnik  Operator = "morsviazsputnik"
	OperatorRuSatAmTel       Operator = "rusat_amtel"
	OperatorIntelsatGeneral  Operator = "intelsat_general"
	OperatorNASAJPL          Operator = "nasa_jpl"
	OperatorRocketLab        Operator = "rocket_lab"
	OperatorCNES             Operator = "cnes"
	OperatorESA              Operator = "esa"
	OperatorKTSat            Operator = "kt_sat"
...
const (
	...
	OrbitGEOMSS               OrbitClass = "geo_mss"
	...
	OrbitOffshore             OrbitClass = "hybrid_satellite_offshore"
	OrbitDeepSpace            OrbitClass = "deep_space"
	OrbitGroundInfrastructure OrbitClass = "ground_infrastructure"
